<template>
  <div class='container content'>
    ...
    <p>Congratulations! Your order for Megacell will be shipped out within 1-2 business days.  <a href=''>support@megacell.com</a>. We sent you a confirmation email for your records. Thanks so much!</p>
...
export default {
  ...
  created(){
    ...
    axios.get(`http:localhost:8080/charge/${charge_id}`)
        .then((res)=>{
